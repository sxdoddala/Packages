create or replace PACKAGE BODY TTEC_AP_ON_HOLD_RPT_OPS AS
--
-- Program Name:  TTEC_AP_ON_HOLD_RPT_OPS
--
-- Description:  This program generates AP On Hold Report for Operations
--
...
FROM   per_all_assignments_f paaf,
       ...
       --hr.per_jobs j				-- Commented code by IXPRAVEEN-ARGANO,17-May-2023
       apps.per_jobs j                --  code Added by IXPRAVEEN-ARGANO,   17-May-2023
...
BEGIN
	  ...
	  Fnd_File.put_line(Fnd_File.LOG, 'Program Name:  TTEC_AP_ON_HOLD_RPT_OPS' );
	  Fnd_File.put_line(Fnd_File.LOG, '**************************************');
      l_rec := '=======================================================';
        apps.fnd_file.put_line(apps.fnd_file.output,l_rec);
      l_rec := 'TeleTech AP Invoice On Hold Report - Operations';
        apps.fnd_file.put_line(apps.fnd_file.output,l_rec);
      l_rec := '=======================================================';
        apps.fnd_file.put_line(apps.fnd_file.output,l_rec);
