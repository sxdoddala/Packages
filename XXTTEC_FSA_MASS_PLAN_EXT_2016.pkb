create or replace PACKAGE BODY XXTTEC_FSA_MASS_PLAN_EXT_2016
 /********************************************************************************
  PROGRAM NAME:   XXTTEC_FSA_MASS_PLAN_EXT_2016
  ...
  CREATED BY:     Jeeva A
  DATE:           17-NOV-2015
  CALLING FROM   :  Teletech PEO Employees FSA and Mass Transit Plans Extract 2016
  ----------------
  MODIFICATION LOG
  ----------------
  ...
  1.0 IXPRAVEEN(ARGANO) 05-May-2023	 R12.2 Upgrade Remediation
  ********************************************************************************/
...
/*FROM   hr.per_all_people_f pap,				-- Commented code by IXPRAVEEN-ARGANO,05-May-2023
       ben.BEN_PRTT_ENRT_RSLT_F pen,*/
FROM   apps.per_all_people_f pap,				--  code Added by IXPRAVEEN-ARGANO,05-May-2023
       apps.BEN_PRTT_ENRT_RSLT_F pen,	
--END R12.2.10 Upgrade remediation	   
       (SELECT *
       --FROM ben.ben_pl_f			-- Commented code by IXPRAVEEN-ARGANO,05-May-2023
       FROM apps.ben_pl_f			--  code Added by IXPRAVEEN-ARGANO,05-May-2023
       ...
       AND hr_person_type_usage_info.get_user_person_type ( trunc(p_date), pap.person_id ) = 'PEO Employee'
...
FROM   apps.per_all_people_f pap,   --  code Added by IXPRAVEEN-ARGANO,05-May-2023
       ...
       (SELECT *
       --FROM ben.ben_pl_f			-- Commented code by IXPRAVEEN-ARGANO,05-May-2023
       FROM ben.ben_pl_f            --  code Added by IXPRAVEEN-ARGANO,05-May-2023
...
END XXTTEC_FSA_MASS_PLAN_EXT_2016;
/
show errors;
/